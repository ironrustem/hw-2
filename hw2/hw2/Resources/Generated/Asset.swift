...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let getMessageTime = ColorAsset(name: "Colors/getMessageTime")
    internal static let mesageFieldView = ColorAsset(name: "Colors/mesageFieldView")
    internal static let messageHeader = ColorAsset(name: "Colors/messageHeader")
